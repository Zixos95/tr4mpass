...
sudo apt-get install -y \
    libimobiledevice-dev libimobiledevice-utils libirecovery-1.0-dev irecovery \
    libusb-1.0-0-dev libplist-dev libssl-dev libcurl4-openssl-dev libssh2-1-dev \
    usbmuxd pkg-config build-essential
```
